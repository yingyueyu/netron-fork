        ...
        if self.path == '/api/export_tensors':
            ...
            try:
                ...
                with open(file_path, 'w', encoding='utf-8') as f:
                  json.dump(post_body, f, ensure_ascii=False, indent=4)
            ...
            # 构造响应体，假设我们只是返回接收到的数据加上一个问候消息
            response = {
                "message": "Hello, I received your data!",
                "yourData": post_body
            }
            # 将字典转换为字符串并编码为bytes类型
